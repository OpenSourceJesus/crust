"""Packaged crust_re source (auto-generated by tools/pack_crust_re.py).
...
HEADER = r'''/* crust_re -- a small backtracking regex engine for Crust.
 *
...
#endif /* CRUST_RE_H */
'''
SOURCE = r'''/* crust_re -- see crust_re.h. Freestanding: no malloc, no locale, no wchar. */
